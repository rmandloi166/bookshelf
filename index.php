  ...
  <table>
    <tr>
      <td  style="padding: 10px;">
        ...
        <h3><a href="description.php?=natures magic"style="text-decoration: none; color: black;">Nature's Magic(1997)<br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="2.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=story behind"style="text-decoration: none; color: black;">Story behind The Tajmahal(1997)<br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="3.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=dusk"style="text-decoration: none; color: black;">Dusk(2010)<br><br></h3>
      </td>
    ...
    <tr>
      <td  style="padding: 10px;">
        ...
        <h3><a href="description.php?=star wars"style="text-decoration: none; color: black;">Star War(1996)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="5.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=fault in our stars"style="text-decoration: none; color: black;">Fault in our stars(2006)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="6.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=monalisa"style="text-decoration: none; color: black;">Monalisa(2001)</a><br><br></h3>
      </td>
    </tr>
    ...
    <tr>
      <td  style="padding: 10px;">
        ...
        <h3><a href="description.php?=bhopal gas tragedy"style="text-decoration: none; color: black;">Bhopal Gas Tragedy(1992)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="8.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=annabelle"style="text-decoration: none; color: black;">Annabelle(2017)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="9.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=beauty and beast"style="text-decoration: none; color: black;">Beauty and beast(2016)</a><br><br></h3>
      </td>
    </tr>
    ...
    <tr>
      <td  style="padding: 10px;">
        ...
        <h3><a href="description.php?=corona"style="text-decoration: none; color: black;">Corona(1983)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="11.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=nm"style="text-decoration: none; color: black;">Nature's Magic 2(1999)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="12.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=mib"style="text-decoration: none; color: black;">Man in black(2003)</a><br><br></h3>
      </td>
    </tr>
    ...
    <tr>
      <td  style="padding: 10px;">
        ...
        <h3><a href="description.php?=love"style="text-decoration: none; color: black;">Love(2006)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="14.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=ae"style="text-decoration: none; color: black;">Albert Einstein(1887)</a><br><br></h3>
      </td>
      <td  style="padding: 10px;">
        <img src="15.jpg" class="img-rounded"width="304" height="300">
        <h3><a href="description.php?=road to success"style="text-decoration: none; color: black;">Road to success(2005)</a><br><br></h3>
      </td>
    </tr>
  </table>
  <ul class="pagination">
